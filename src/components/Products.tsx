    ...
    <section id="products" className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-shree-blue mb-4">
            Our Products
          </h2>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Explore our comprehensive range of high-quality pharma, nutraceutical, and chemical products.
          </p>
          <div className="w-20 h-1 bg-shree-light-blue mx-auto mt-4"></div>
        </div>

        <div className="grid md:grid-cols-2 gap-10">
          {/* Pharma & Nutraceutical */}
          <div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition duration-300">
            <h3 className="text-2xl font-semibold text-shree-blue mb-4 border-b-2 border-shree-light-blue pb-2">
              Pharma & Nutraceutical
            </h3>
            <ul className="space-y-2 text-gray-600 text-left">
              {pharmaProducts.map((item, index) => (
                <li 
                  key={index}
                  className="hover:text-shree-blue hover:translate-x-1 transition duration-300 flex items-center gap-2"
                >
                  <span className="text-shree-light-blue">•</span> {item}
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition duration-300">
            ...
            <ul className="space-y-2 text-gray-600 text-left">
              ...
              <li className="font-medium pt-2 text-gray-500">... and more.</li>
            </ul>
          </div>
        </div>
      </div>
